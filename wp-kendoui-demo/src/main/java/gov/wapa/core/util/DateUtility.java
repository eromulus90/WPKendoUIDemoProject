...
public class DateUtility {
	...
	public static boolean isDateXDaysOrMoreInFuture(Date testDate, int numDays) {
		...
		if (DateUtility.datesAreEqual(testDate, currentDate)) {
			return false;
		}
		...
		if (DateUtility.datesAreEqual(testDate, futureDate)) {
			return true;
		} else {
	...
	public static boolean isDateXDaysOrMoreInPast(Date testDate, int numDays) {
		...
		if (DateUtility.datesAreEqual(testDate, pastDate)) {
			return true;
		} else {
	...
	public static ZonedDateTime convertToTimeZone(Calendar calendar) {
		...
		ZonedDateTime zonedDateTime = ZonedDateTime.of(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH),
